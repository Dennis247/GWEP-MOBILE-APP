...
MapMarker createMarkerWithImagePath(
  ...
  MapImage mapImage =
      MapImage.withFilePathAndWidthAndHeight(imagePath, width, height);
  MapMarker mapMarker = createMarkerWithImage(coordinates, mapImage,
      drawOrder: drawOrder, anchor: anchor);
  return mapMarker;
}
...
extension LogicalCoords on HereMapController {
  ...
  void zoomToLogicalViewPort({
    ...
    zoomGeoBoxToLogicalViewPort(
      geoBox: geoBox,
      viewPort: Rect.fromLTRB(0, MediaQuery.of(context).padding.top,
...
void setTrafficLayersVisibilityOnMap(
  ...
  bool enableTraffic =
      appPreferences.useAppOffline ? false : appPreferences.showTrafficLayers;
  if (enableTraffic) {
