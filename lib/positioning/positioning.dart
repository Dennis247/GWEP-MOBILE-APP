...
typedef LocationEngineStatusCallback = void Function(
    LocationEngineStatus status);
...
mixin Positioning {
  ...
  void _onLocationUpdated(Location location) {
    ...
    final double accuracy = (location.horizontalAccuracyInMeters != null)
        ...
        : 0.0;
    _locationAccuracyCircle?.geometry =
        _createGeometry(location.coordinates, accuracy);
