...
class WaterBodyDetails2Data {
  WaterBodyDetails2? data;
  bool? succeeded;
  String? message;

  WaterBodyDetails2Data({this.data, this.succeeded, this.message});

  WaterBodyDetails2Data.fromJson(Map<String, dynamic> json) {
    data =
        json['data'] != null ? WaterBodyDetails2.fromJson(json['data']) : null;
...
class WaterBodyDetails2 {
  String? type;
  String? name;
  Crs? crs;
  List<Features>? features;

  WaterBodyDetails2({this.type, this.name, this.crs, this.features});

  WaterBodyDetails2.fromJson(Map<String, dynamic> json) {
    type = json['type'];
    name = json['name'];
...
class Features {
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['waterBodyId'] = this.waterBodyId;
    data['type'] = this.type;
    if (this.properties != null) {
      data['properties'] = this.properties!.toJson();
    }
