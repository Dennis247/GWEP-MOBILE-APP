...
class _RouteDetailsScreenState extends State<RouteDetailsScreen> {
  ...
  Widget build(BuildContext context) => WillPopScope(
          ...
          if (_hasBeenZoomedToManeuver) {
            if (_maneuversSheetIsExpanded) {
              DraggableScrollableActuator.reset(
                  _bottomSheetKey.currentContext!);
              _hereMapController.setWatermarkPlacement(
                  WatermarkPlacement.bottomCenter, 0);
            }
        ...
        child: Scaffold(
          ...
          extendBody: true,
          bottomNavigationBar:
              _mapInitSuccess ? _buildBottomSheet(context) : null,
        ),
      );
  ...
  _addRouteToMap() {
    _mapRoute = MapPolyline(widget.route.geometry, UIStyle.routeLineWidth,
    ...
    MapImage mapImage = MapImage.withFilePathAndWidthAndHeight(
        "assets/maneuver.svg", markerSize, markerSize);
